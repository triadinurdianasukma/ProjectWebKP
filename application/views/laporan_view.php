...
<nav class="navbar navbar-default navbar-static-top">
    ...
    <div class="side-menu">
        ...
        <div class="panel panel-default">
         <div class="panel-heading" align="center">Rekap Inventaris Software Komputer  </div>
        <div class="panel-body" align="center"><span class="glyphicon glyphicon-save-file"></span><a href="<?=base_url()?>laporan/eksportexcelsoft">Software</a></div>
        <div class="panel-body" align="center"><span class="glyphicon glyphicon-save-file"></span><a href="<?=base_url()?>laporan/eksportexcelhard">Hardware</a></div>
       <div class="panel-body" align="center"><span class="glyphicon glyphicon-save-file"></span><a href="<?=base_url()?>laporan/eksportexcels">Semua Data</a></div>
       </div> 
    </div> 
</div> 
</body> 
